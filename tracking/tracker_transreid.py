...
from reid_model_trans import TransReIDModel
reid_model = TransReIDModel(
    config_file="tracking/TransReID/configs/MSMT17/vit_transreid_stride.yml",
    model_weights="tracking/transreid_weights/vit_transreid_msmt.pth",
    device="cpu"
)
